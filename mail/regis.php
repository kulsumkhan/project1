...
<table width="90%" border="1" align="center">
  ...
  <tr>
    <td width="204" height="47">Enter company name </td>
  ...
  <tr>
    <td height="47">Enter company conatct_no </td>
    <td><input type="text" name="mob"/></td>
  </tr>
  <tr>
    <td height="39">Enter Email of your company </td>
    <td><input type="email" name="eid"/></td>
  </tr>
  <tr>
    <td height="41">Select ownership </td>
    <td>
		PRIVATE<input type="checkbox" name="ch[]" value="private"/>
		PUBLIC<input type="checkbox" name="ch[]" value="public"/>
		
	</td>
  </tr>
  <tr>
    <td height="38">INCORPORATED </td>
    <td>
		<select name="y">
  ...
  <tr>
    <td height="55">Upload Company image</td>
    <td>
