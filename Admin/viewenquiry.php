...
<tr><td style="font-size:25px; padding:25px; font-weight:bold;" >Name Of Company</td>
<td style="font-size:25px; padding:25px; font-weight:bold;">Sended Message</td></tr>


<?php

$s="select * from message,advertisement where advertisement.Advid=package.Packid";
