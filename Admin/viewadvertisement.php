...
<td style="font-size:15px; padding:10px; font-weight:bold;">details</td></tr>
...
while($data=mysqli_fetch_array($result))
{
		...
		echo "<tr><td style=' padding:5px;'>$data[0]</td><td style=' padding:5px;'>$data[1]</td><td style=' padding:5px;'>$data[2]</td><td style=' padding:10px;'>$data[3]</td><td style='height:50px' /></td></tr>";
